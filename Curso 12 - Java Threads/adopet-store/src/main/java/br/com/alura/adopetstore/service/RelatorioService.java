...
public class RelatorioService {
    ...
    //O Future é uma classe muito parecida com o Optional, um container que guarda esses tipos que queremos recuperar mais tarde
    @Async //transformou esse metodo em uma thread do spring
