...
public class OperacaoSaque implements Runnable{
    ...
    /**
     * synchronized muda o fluxo da aplicação evitando saldo negativo na conta e informações desatualizadas
     */
    ...
    public void run() {
        executa();
        System.out.println(Thread.currentThread().getName()); //traz o nome da Thread atual que esta sendo executada
    }
}
