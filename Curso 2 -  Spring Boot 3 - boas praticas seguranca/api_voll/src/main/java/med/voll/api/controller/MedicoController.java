...
public class MedicoController {
    ...
    public Page<DadosListagemMedico> listarMedicosAtivos(@PageableDefault(size = 10, sort = {"nome"}) Pageable paginacao) {
    ...
    //deleção lógica do objeto, ou seja, ele não é apagado do banco fica apenas inativo no sistema
    @DeleteMapping("/{id}")
    @Transactional
