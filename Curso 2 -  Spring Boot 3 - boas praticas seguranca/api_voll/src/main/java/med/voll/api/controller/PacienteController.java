...
public class PacienteController {
    ...
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroPaciente dados, UriComponentsBuilder uriBuilder) {
        ...
        return ResponseEntity.created(uri).body(new DadosExibicaoPaciente(paciente));
    }
    ...
    public ResponseEntity<List<DadosListagemPaciente>> listar() {
        ...
        var list = repository.findAll().stream().map(DadosListagemPaciente::new).toList();
    ...
    public ResponseEntity atualizar(@RequestBody @Valid DadosAtualizacaoPaciente dados) {
        ...
        return ResponseEntity.ok(new DadosExibicaoPaciente(paciente));
    }
